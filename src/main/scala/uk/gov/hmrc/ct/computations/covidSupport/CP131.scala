...
case class CP131(value: Option[Int]) extends CtBoxIdentifier(name = "Ppe covid support grants") with CtOptionalInteger with Input with ValidatableBox[ComputationsBoxRetriever]  {
