...
import uk.gov.hmrc.ct.computations.covidSupport.{CP121, CP122, CP123, CP124, CP125a, CP125b, CP131}
...
package object formats {
  ...
  implicit val CP131Format: Format[CP131] = new OptionalIntegerFormat[CP131](CP131.apply)
